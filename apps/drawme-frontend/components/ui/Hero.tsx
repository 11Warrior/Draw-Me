      ...
      <div className="mx-auto max-w-6xl">
        <div className="flex flex-col items-center text-center">
          ...
          >
            <a
              href="/draw"
              className="inline-flex items-center gap-2 rounded-lg bg-primary border border-border bg-background px-6 py-3 text-base font-semibold text-primary-foreground transition-transform hover:scale-[1.02] active:scale-[0.98]"
            >
              Start Drawing
